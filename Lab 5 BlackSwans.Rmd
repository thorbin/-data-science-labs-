...
milk_1997 <- milk %>%
  filter(year == 1997)
```
## Then, I used ggplot and geom_histogram to view the milk produced in millions in the year 1997. Histogram graphs show the frequency a value in the data set occurs. In this case, most states produced below 5 billion gallons of milk in 1997, with some outliers of course. There were 3 states that produced over 10 billion gallons of milk. 
```{r}
