...
mean(merged$Score.y)
```
#the total time and its relation with the Answer and Question scores display a non-uniform behavior. 
#There is still a significant amount of outliers that do affect the relationship between score and total time. 
#One hypothesis to explain the vast amount of outlier scores is because those answer and question scores that fall above the mean are those who which users find to have the most utility.
#thus, there are going to be a lot of low utility questions and answers, but those who have high utility will standout in their scores as they are generally useful to most who encounter them. 
#Its functions to scores are similar to the price law or the Mathew principle. A small minority generates the most innovation in a given creative domine. 

#---------------------------------------------------------------------------------end Timeliness Jorge-part
#----------------------------------------------------------------------------------
#exploring feature and analysis

#To finds out if there is a relation in what makes an appropriate answer and questions would be best at first to focus at the lowest resolution in relation to the given topic
...
#This is important because it is the outlies that display questions and answers that have high utility. 
#Thus, perhaps the reason for this effect is that it is a question or answer that does not define itself a the lowest resolution with proper keywords like code then, the probability of a user finding that question or answer relevant diminishes.
### end Jorge. 
