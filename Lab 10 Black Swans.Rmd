...
answersjj <- read_csv("~/Desktop/lab10/answersj_trunc.csv")
questionjsj <- read_csv("~/Desktop/lab10/questionjs_trunc.csv")
...
mean(questionjs$Score)
writeLines("\nRange for questionjs Score")
range(questionjs$Score)
