...
I, Ryan Bilkie, created three plots illustrating the distribution of health plans among smokers and non-smokers and its relationship to overall health. The data showed that the health pattern was the same between smokers and non-smokers. I used the geom_point function with position = "jitter" to show a cluster of points and I compared the density of the categories, and I used color to differentiate smokers from non-smokers.
...
```
  ...
  These two graphs compare non-smokers (graph on the top) to smokers (graph on the bottom) based on weight. Each bar represents how many 
