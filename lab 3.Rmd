...
conclusion: while it is not clear what the mechanism behind the increase in health for male smokers is, it appears as though there is no evidence to support a gender related health trend from the above plots. This is based on the fact that male smokers and female non smoker subjects diplay the same negative decline in health around year 80. As for the conclusion that the raw data seems to support, if you are a male, when you are 80, smoke up bud.  
=======
end Thorbin
