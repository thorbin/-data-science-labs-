...
### Erik's question: What is the relationship between birth weight in ounces and gestation period from the perspective of non-smoking and smoking parties? 
...
```
This plot shows that the average birth weight is around 120 (troy?) ounces at on average 310 days gestating. Upon initial inspection it appears as though the bulk of these babies are born in healthy gestation terms, while this is true, a significant portion is also born under weight and under gestated. The following plot provides grounds for comparison.
```{R}
