...
The dataset used in this analysi, which was imported from the UCI ML Repository (https://archive.ics.uci.edu/ml/datasets/individual+household+electric+power+consumption), contains data on household appliances and power usage. Our team each individually cleaned the data and produced our own individual findings and analyses.
